...
<body>
  ...
  <main>
    ...
    <br><div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="./img/1_1.jpg" role="img"
        ...
        <div class="col-lg-4">
          <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="./img/333.jpg" role="img"
            aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false">
          <title>Placeholder</title>
        ...
        <div class="col-lg-4">
          <img class="bd-placeholder-img rounded-circle" width="140" height="140" src="./img/444.jpg" role="img"
            aria-label="Placeholder" preserveAspectRatio="xMidYMid slice" focusable="false">
          <title>Placeholder</title>
          <rect width="100%" height="100%" fill="var(--bs-secondary-color)"></rect></img>
   ...
   <!-- ต่อรองราคากับร้านให้จนกว่าลูกค้าจะพอใจ</p> -->
        ...
        <div class="container px-4 py-5" id="hanging-icons">
          ...
          <div class="col d-flex align-items-start">
            ...
            <div>
              <p>เลขทะเบียน : 0473557000113</p>
              <p>ประกอบธุรกิจ : จำหน่ายโทรศัพท์มือถือทุกรุ่น</p>
              <p>หมวดธุรกิจ : ร้านขายปลีกอุปกรณ์การสื่อสารโทรคมนาคม</p>
              <p>สถานะ : ยังดำเนินกิจการอยู่</p>
              <p>วันที่จดทะเบียน : 24 มกราคม 2557</p>
              <p>ที่ตั้ง : 197 หมู่ 9 ตำบล โนนหอม อำเภอ เมืองสกลนคร จังหวัด สกลนคร 47000</p>
            </div>
          </div>
        </div>
